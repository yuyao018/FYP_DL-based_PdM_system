...
# ── Developer Login page layout ──────────────────────────────────────────────────
def create_dev_login_layout():
    return html.Div(
        style={
        ...
        children=[
            ...
            html.Div(
                ...
                children=[
                    html.H2("Developer Portal", style={
                        "color": "white", "fontWeight": "700", "fontSize": "28px",
                        "marginBottom": "8px", "textAlign": "center",
                    }),
                    html.P("Sign in with your developer credentials", style={
                    ...
                    # Status message
                    html.Div(id="dev-login-status", style={"minHeight": "24px", "marginBottom": "12px"}),
                    ...
                    html.Div(
                        ...
                        children=[
                            html.Div(style={
                                ...
                                html.Span("DEVELOPER ACCESS", style={
